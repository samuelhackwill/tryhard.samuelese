export const textArr = {
  acte1: [
    ...
    [
      "huh et ça ça serait une deuxième phrase? est ce que vraiment c'est intréressant de fonctionner comme ça? peut être qu'il y aura plusieurs personnages?",
      "si c'est le cas il faudra une datastructure différente",
      "nous verrons puis nous comprendrons.",
    ],
    ["voilà le texte est finni"],
  ],
};
